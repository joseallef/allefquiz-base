    ...
    <Widget>
      ...
      <Widget.Content>
        ...
        >
          ...
          {isQuestionSubmited && isCorrect && <Widget.MessageSuccess>Acertou bobonica!</Widget.MessageSuccess>}
          {isQuestionSubmited && !isCorrect && <Widget.MessageErro>Errasse bexiga lixa!</Widget.MessageErro>}
        </AlternativesForm>
      </Widget.Content>
    </Widget>
  );
